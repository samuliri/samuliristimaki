...
TitleAndMetaTags.defaultProps = {
	...
	desc:
		'Just a simple Finnish / American dude, who currently is working as an all-around Developer, and wants to create awesome stuff. This site is build with Gatsby, React and GraphQL.'
};
